...
const UserGuide = ({
  ...
  return (
    <div className="w-[90%] md:w-[520px] h-[300px] md:h-[400px] xl:w-[580px] xl:h-[450px] p-5 md:p-8 xl:p-10 flex flex-col justify-center items-center gap-6 md:gap-8 bg-linear-to-br from-[#0a3d15]/40 via-[#0d5720]/35 to-[#0a3d15]/40 backdrop-blur-xs border-[#4ade80] border-2 rounded-3xl drop-shadow-2xl fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50">
